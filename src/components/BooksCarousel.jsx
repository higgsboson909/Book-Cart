...
const BooksCarousel = ({
  title = "Online Bazar Upto 60% Off",
  books = dummyBooks,
}) => {
  return (
    <div className="w-full flex justify-center px-20 max-md:px-10 max-sm:px-5 py-10  flex-col items-center">
      <h3 className="title text-xl font-semibold sm:text-xl md:text-2xl lg:text-4xl py-2  eb-garamond-h3">
        {title}
      </h3>
      <Swiper
        slidesPerView={1}
